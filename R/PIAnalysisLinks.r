PIAnalysisLinks <- function(self = NULL, target = NULL, database = NULL, categories = NULL, template = NULL, analysisRule = NULL, analysisRulePlugIn = NULL, timeRule = NULL, timeRulePlugIn = NULL, security = NULL, securityEntries = NULL) {
	...
	attr(valueCleaned, "className") <- "PIAnalysisLinks"
	return(valueCleaned)
}
