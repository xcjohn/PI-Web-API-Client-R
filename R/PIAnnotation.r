PIAnnotation <- function(id = NULL, name = NULL, description = NULL, value = NULL, creator = NULL, creationDate = NULL, modifier = NULL, modifyDate = NULL, links = NULL, webException = NULL) {
	if (is.null(id) == FALSE) {
	...
	if (is.null(links) == FALSE) {
		...
		if ((is.null(className)) || (className != "PIAnnotationLinks")) {
			return (print(paste0("Error: the class from the parameter links should be PIAnnotationLinks.")))
		}
	}
