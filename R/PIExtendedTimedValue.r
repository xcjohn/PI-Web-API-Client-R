PIExtendedTimedValue <- function(annotations = NULL, timestamp = NULL, unitsAbbreviation = NULL, good = NULL, questionable = NULL, substituted = NULL, annotated = NULL, value = NULL, errors = NULL, webException = NULL) {
