PIAssetDatabase <- function(webId = NULL, id = NULL, name = NULL, description = NULL, path = NULL, extendedProperties = NULL, links = NULL, webException = NULL) {
	...
	if (is.null(links) == FALSE) {
		...
		if ((is.null(className)) || (className != "PIAssetDatabaseLinks")) {
			return (print(paste0("Error: the class from the parameter links should be PIAssetDatabaseLinks.")))
		}
	}
