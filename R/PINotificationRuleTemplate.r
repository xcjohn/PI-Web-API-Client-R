PINotificationRuleTemplate <- function(webId = NULL, id = NULL, name = NULL, description = NULL, path = NULL, categoryNames = NULL, criteria = NULL, multiTriggerEventOption = NULL, nonrepetitionInterval = NULL, resendInterval = NULL, status = NULL, templateName = NULL, webException = NULL) {
