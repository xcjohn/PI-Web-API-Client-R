PISecurityRights <- function(ownerWebId = NULL, securityItem = NULL, userIdentity = NULL, links = NULL, canAnnotate = NULL, canDelete = NULL, canExecute = NULL, canRead = NULL, canReadData = NULL, canSubscribe = NULL, canSubscribeOthers = NULL, canWrite = NULL, canWriteData = NULL, hasAdmin = NULL, rights = NULL, webException = NULL) {
	...
	if (is.null(links) == FALSE) {
		...
		if ((is.null(className)) || (className != "PISecurityRightsLinks")) {
			return (print(paste0("Error: the class from the parameter links should be PISecurityRightsLinks.")))
		}
	}
