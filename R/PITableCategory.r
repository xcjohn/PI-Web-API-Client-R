PITableCategory <- function(webId = NULL, id = NULL, name = NULL, description = NULL, path = NULL, links = NULL, webException = NULL) {
	...
	if (is.null(links) == FALSE) {
		...
		if ((is.null(className)) || (className != "PITableCategoryLinks")) {
